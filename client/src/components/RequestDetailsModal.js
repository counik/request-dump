...
export default function RequestDetailsModal({ activeRequestId, closeModal }) {
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    {/* <p className="text-sm text-gray-500">
                      ...
                      forever. This action cannot be undone. Are you sure you
                      ...
                      account? All of your data will be permanently removed from
                      our servers forever. This action cannot be undone. Are you
                      sure you want to deactivate your account? All of your data
                      will be permanently removed from our servers forever. This
                      action cannot be undone.
                    </p> */}
                    <HeaderInfo headers={request.data.headers} />
                  </div>
                </div>
              </div>
